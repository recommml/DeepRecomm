...
def parse_args():
    ...
    parser.add_argument('--embed_size', type=int, default=64,
                        help='Embedding size.')
    parser.add_argument('--user_embed_size', type=int, default=64,
                        help='Embedding size.')
    parser.add_argument('--item_embed_size', type=int, default=64,
                        help='Embedding size.')
    parser.add_argument('--layer_size', nargs='?', default='[64]',
                        help='Output sizes of every layer')
    parser.add_argument('--user_layer_size', nargs='?', default='[64]',
                        help='Output sizes of every layer')
    parser.add_argument('--item_layer_size', nargs='?', default='[64]',
                        help='Output sizes of every layer')
    parser.add_argument('--nmf_weights', nargs='?', default='[64]',
                        help='Output sizes of every mlp layer for NeuMF')
    parser.add_argument('--batch_size', type=int, default=1024,
                        help='Batch size.')
    parser.add_argument('--double_graph_type', type=int, default=1,
                        help='1 for double graph; 2 for user graph only; 3 for item graph only.')
