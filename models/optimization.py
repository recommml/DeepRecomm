...
def create_adam_optimizer(loss, init_lr, num_train_steps, num_warmup_steps, use_tpu):
...
def create_adam_weight_decay_optimizer(loss, init_lr, num_train_steps, num_warmup_steps, use_tpu):
    """Creates an optimizer training op."""
    global_step = tf.train.get_or_create_global_step()
